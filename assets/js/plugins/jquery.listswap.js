(function($) {
    $.fn.listswap = function(options) {		
		...
		var add_btn_id = "addall_" + rand;
		var rem_btn_id = "remall_" + rand;
		var addAllAgentsCb = options.addAllAgentsCb;
		var remAllAgentsCb = options.remAllAgentsCb;
		var div_class_ = '';
		var rtl_class_ = '';
		...
		var controls = '<div class="listbox_controls">' + 
							'<ul>' +
								   '<li class="add" id="'+add_btn_id+'"><span><i class="fas fa-angle-double-right" style="color: gray"/></span></li>'+
								   ...
								   '<li class="remove" id="'+rem_btn_id+'"><span><i class="fa fa-angle-double-left" style="color: gray"/></span></li>'
							'</ul>' +
					   '</div>';
		...
		$('#'+add_btn_id).click(function() {
			console.log("add "+source_select_id);
			$("#"+source_select_id+" option").each(function(i){
				//alert($(this).text() + " : " + $(this).val());
				//var option_item = '<option value="'+$(this).val()+'">'+$(this).text()+'</option>';
				//$('#'+destination_select_id+' select').append(option_item);
				add_remove_handler($(this), div_id + ' .destination_wrapper ul', source_select_id, destination_select_id);
			});
			refresh_list();
		});

		$('#'+rem_btn_id).click(function() {
			console.log("deleted "+destination_select_id);
		});
